<template>
  <div class="result-table-content">
    ...
    <div class="results-summary">
      <table v-if="tableData.totals" class="table table-striped">
        <tbody>
          <tr>
            <th>Category</th>
        ...
        tableData['categories'][0].drugAge.count
          ...
          <tr>
            ...
            <td>{{ calcPercentage(tableData['categories'][1].drugDose.good, tableData['categories'][1].drugDose.count)
              }} <span class="success">({{ tableData['categories'][1].drugDose.good }}/{{
        ...
        tableData['categories'][1].drugDose.count }})</span></td>
          ...
          <tr>
            ...
            <td>{{ calcPercentage(tableData['categories'][2].drugInteraction.good,
        tableData['categories'][2].drugInteraction.count)
              }} <span class="success">({{ tableData['categories'][2].drugInteraction.good }}/{{
        tableData['categories'][2].drugInteraction.count }})</span></td>
            <td>{{ calcPercentage(tableData['categories'][2].drugInteraction.some,
        tableData['categories'][2].drugInteraction.count)
              }} <span class="warning">({{ tableData['categories'][2].drugInteraction.some }}/{{
        tableData['categories'][2].drugInteraction.count }})</span></td>
            <td>{{ calcPercentage(tableData['categories'][2].drugInteraction.not,
        tableData['categories'][2].drugInteraction.count)
              }} <span class="danger">({{ tableData['categories'][2].drugInteraction.not }}/{{
        tableData['categories'][2].drugInteraction.count }})</span></td>
            <td>{{ calcPercentage(tableData['categories'][2].drugInteraction.over,
        tableData['categories'][2].drugInteraction.count)
        ...
        tableData['categories'][2].drugInteraction.count }})</span></td>
          ...
          <tr>
            ...
            <td>{{ calcPercentage(tableData['categories'][3].drugAllergy.good,
        tableData['categories'][3].drugAllergy.count) }}
              <span class="success">({{ tableData['categories'][3].drugAllergy.good }}/{{
        tableData['categories'][3].drugAllergy.count }})</span>
            </td>
            <td>{{ calcPercentage(tableData['categories'][3].drugAllergy.some,
        tableData['categories'][3].drugAllergy.count) }}
              <span class="warning">({{ tableData['categories'][3].drugAllergy.some }}/{{
        tableData['categories'][3].drugAllergy.count }})</span>
            </td>
            <td>{{ calcPercentage(tableData['categories'][3].drugAllergy.not,
        tableData['categories'][3].drugAllergy.count) }} <span class="danger">({{
        tableData['categories'][3].drugAllergy.not }}/{{
        tableData['categories'][3].drugAllergy.count }})</span></td>
            <td>{{ calcPercentage(tableData['categories'][3].drugAllergy.over,
        tableData['categories'][3].drugAllergy.count) }}
        ...
        tableData['categories'][3].drugAllergy.count }})</span>
          ...
          <tr>
            ...
            <td>{{ calcPercentage(tableData['categories'][4].drugDuplication.good,
        tableData['categories'][4].drugDuplication.count)
              }} <span class="success">({{ tableData['categories'][4].drugDuplication.good }}/{{
        tableData['categories'][4].drugDuplication.count }})</span> </td>
            <td>{{ calcPercentage(tableData['categories'][4].drugDuplication.some,
        tableData['categories'][4].drugDuplication.count)
              }} <span class="warning">({{ tableData['categories'][4].drugDuplication.some }}/{{
        tableData['categories'][4].drugDuplication.count }})</span></td>
            <td>{{ calcPercentage(tableData['categories'][4].drugDuplication.not,
        tableData['categories'][4].drugDuplication.count)
              }} <span class="danger">({{ tableData['categories'][4].drugDuplication.not }}/{{
        tableData['categories'][4].drugDuplication.count }})</span></td>
            <td>{{ calcPercentage(tableData['categories'][4].drugDuplication.over,
        tableData['categories'][4].drugDuplication.count)
        ...
        tableData['categories'][4].drugDuplication.count }})</span></td>
          ...
          <tr>
            ...
            <td>{{ calcPercentage(tableData['categories'][5].drugDisease.good,
        tableData['categories'][5].drugDisease.count) }}
              <span class="success">({{ tableData['categories'][5].drugDisease.good }}/{{
        tableData['categories'][5].drugDisease.count }})</span>
            </td>
            <td>{{ calcPercentage(tableData['categories'][5].drugDisease.some,
        tableData['categories'][5].drugDisease.count) }}
              <span class="warning">({{ tableData['categories'][5].drugDisease.some }}/{{
        tableData['categories'][5].drugDisease.count }})</span>
            </td>
            <td>{{ calcPercentage(tableData['categories'][5].drugDisease.not,
        tableData['categories'][5].drugDisease.count) }} <span class="danger">({{
        tableData['categories'][5].drugDisease.not }}/{{
        tableData['categories'][5].drugDisease.count }})</span></td>
            <td>{{ calcPercentage(tableData['categories'][5].drugDisease.over,
        tableData['categories'][5].drugDisease.count) }}
        ...
        tableData['categories'][5].drugDisease.count }})</span>
          ...
          <tr>
            ...
            <td>{{ calcPercentage(tableData['categories'][6].drugOmissions.good,
        tableData['categories'][6].drugOmissions.count) }}
              <span class="success">({{ tableData['categories'][6].drugOmissions.good }}/{{
        tableData['categories'][6].drugOmissions.count }})</span>
            </td>
            <td>{{ calcPercentage(tableData['categories'][6].drugOmissions.some,
        tableData['categories'][6].drugOmissions.count) }}
              <span class="warning">({{ tableData['categories'][6].drugOmissions.some }}/{{
        tableData['categories'][6].drugOmissions.count }})</span>
            </td>
            <td>{{ calcPercentage(tableData['categories'][6].drugOmissions.not,
        tableData['categories'][6].drugOmissions.count) }}
              <span class="danger">({{ tableData['categories'][6].drugOmissions.not }}/{{
        tableData['categories'][6].drugOmissions.count }})</span>
            </td>
            <td>{{ calcPercentage(tableData['categories'][6].drugOmissions.over,
        tableData['categories'][6].drugOmissions.count) }}
        ...
        tableData['categories'][6].drugOmissions.count }})</span>
          ...
          <tr>
            ...
            <td>{{ calcPercentage(tableData['categories'][7].theraputicDuplication.good,
        ...
        tableData['categories'][9].drugBrand.count }})</span></td>
          ...
          <tr>
            ...
            <td>{{ calcPercentage(tableData['categories'][10].drugRoute.good,
        tableData['categories'][10].drugRoute.count) }} <span class="success">({{
        tableData['categories'][10].drugRoute.good }}/{{
        tableData['categories'][10].drugRoute.count }})</span></td>
            <td>{{ calcPercentage(tableData['categories'][10].drugRoute.some,
        tableData['categories'][10].drugRoute.count) }} <span class="warning">({{
        tableData['categories'][10].drugRoute.some }}/{{
        tableData['categories'][10].drugRoute.count }})</span></td>
            <td>{{ calcPercentage(tableData['categories'][10].drugRoute.not,
        tableData['categories'][10].drugRoute.count) }} <span class="danger">({{
        tableData['categories'][10].drugRoute.not }}/{{
        tableData['categories'][10].drugRoute.count }})</span></td>
            <td>{{ calcPercentage(tableData['categories'][10].drugRoute.over,
        tableData['categories'][10].drugRoute.count) }} <span class="info">({{
        tableData['categories'][10].drugRoute.over }}/{{
        tableData['categories'][10].drugRoute.count }})</span></td>
          </tr>
          <tr>
            <td>Drug Overdose ({{ tableData['categories'][11].drugOverdose.count }})</td>
            <td>{{ calcPercentage(tableData['categories'][11].drugOverdose.good,
        tableData['categories'][11].drugOverdose.count) }}
              <span class="success">({{ tableData['categories'][11].drugOverdose.good }}/{{
        tableData['categories'][11].drugOverdose.count }})</span>
            </td>
            <td>{{ calcPercentage(tableData['categories'][11].drugOverdose.some,
        tableData['categories'][11].drugOverdose.count) }}
              <span class="warning">({{ tableData['categories'][11].drugOverdose.some }}/{{
        tableData['categories'][11].drugOverdose.count }})</span>
            </td>
            <td>{{ calcPercentage(tableData['categories'][11].drugOverdose.not,
        tableData['categories'][11].drugOverdose.count) }}
              <span class="danger">({{ tableData['categories'][11].drugOverdose.not }}/{{
        tableData['categories'][11].drugOverdose.count }})</span>
            </td>
            <td>{{ calcPercentage(tableData['categories'][11].drugOverdose.over,
        tableData['categories'][11].drugOverdose.count) }}
        ...
        tableData['categories'][11].drugOverdose.count }})</span>
          ...
          <tr>
            ...
            <td>{{ calcPercentage(tableData['categories'][12].drugFrequency.good,
        ...
        tableData['categories'][12].drugFrequency.count)
            ...
            <td>{{ calcPercentage(tableData['categories'][12].drugFrequency.not,
              ...
              <span class="danger">({{ tableData['categories'][12].drugFrequency.not }}/{{
                tableData['categories'][12].drugFrequency.count }})</span>
            </td>
            <td>{{ calcPercentage(tableData['categories'][12].drugFrequency.over,
              tableData['categories'][12].drugFrequency.count)
              }} <span class="info">({{ tableData['categories'][12].drugFrequency.over }}/{{
                tableData['categories'][12].drugFrequency.count }})</span></td>
          </tr>
          <tr>
            <th>All Categories <span class="note">*</span></th>
...
export default {
  ...
  setup() {
    // https://github.com/vuejs/core/discussions/6398 - composables not usable within a template unless you do this...
