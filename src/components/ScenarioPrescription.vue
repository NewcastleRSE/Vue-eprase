  ...
  <div>
    <div id="test-scenario">
      ...
      <div class="prescription-info">
        <p>Prescribe the following medication to the specified patient using your normal prescribing practice, then
          answer the questions below.<br /></p>
    ...
    <div class="form-group footer mx-auto">
      <div class="buttons">
        <button v-show='nextEnabled' id="next-button" type="button" class="scenario-btn btn btn-primary"
          @click="onNextClick()" :disabled="isFormInvalid">Next</button>
        <button v-show='doneEnabled' id="done-button" type="button" class="scenario-btn btn btn-primary"
